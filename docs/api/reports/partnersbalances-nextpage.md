...
Retrieves the next page of an ongoing `/v1/reports/partnersbalances` request.

## Endpoint

- **Base URL:** `https://api.armsoft.am/accountant/v1`
- **Method:** `POST`
- **Route:** `/v1/reports/partnersbalances/nextpage`
...
Returns the same `PartnersBalancesDataRowApiResponse` format as the initial call.

## Usage example

```bash
curl -X POST "https://api.armsoft.am/accountant/v1/reports/partnersbalances/nextpage" \
