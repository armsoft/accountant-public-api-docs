...
Retrieves the next page of an ongoing `/v1/journals/alldocuments` request.

## Endpoint

- **Base URL:** `https://api.armsoft.am/accountant/v1`
- **Method:** `POST`
- **Route:** `/v1/journals/alldocuments/nextpage`
...
Returns the same `AllDocumentsJournalDataRowApiResponse` format as the initial call.

## Usage example

```bash
curl -X POST "https://api.armsoft.am/accountant/v1/journals/alldocuments/nextpage" \
